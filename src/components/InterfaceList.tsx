...
import { Network, Activity, Settings, RefreshCw, X, Check } from "lucide-react";
        ...
        {interfaces.length === 0 ? (
          ...
          interfaces
            ...
            .map((iface) => {
              ...
              if (isEditing) {
                  return (
                    <div key={iface.ip} className="p-3 bg-neutral-800 border-b border-neutral-700 space-y-3">
              ...
              return (
                <button
                  ...
                  onDoubleClick={() => handleDoubleClick(iface)}
